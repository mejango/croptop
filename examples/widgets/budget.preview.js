...
export default function (el) {
  ...
  el.innerHTML = `<div style="position:absolute;inset:0;padding:7%;display:flex;flex-direction:column;justify-content:center;gap:9%">
    ${names.map((n, i) => `<div><div style="display:flex;justify-content:space-between;font-size:12px;opacity:.7"><span>${n}</span><span class="p"></span></div>
    ...
    <div style="font-size:12px;opacity:.5;text-align:right">how would you spend $250,000?</div></div>`;
